...
/**
 * Hand Movement Test Session
 *
 * Uses the device camera to record a 15-second hand movement clip.
 * On mobile, real-time landmark extraction is not yet available natively;
 * the recorded video URI is displayed and can be uploaded in a future
 ...
 * model and wire the extracted wrist coordinates to processLineFollowSession().
 */
export default function HandMovementSessionScreen() {
      ...
      <ScreenWrapper>
        <Card>
          ...
          <Text style={styles.permissionBody}>
            This test uses your camera to record your hand movement.
          </Text>
  ...
  return (
    <View style={styles.fullScreen}>
      ...
      <View style={styles.overlay}>
        ...
        <Text style={styles.guideLabel}>Move your wrist from green → red</Text>
      </View>
